...
- [ ] 6.2 Merge delta specs into `openspec/specs/action-execution/spec.md` and `openspec/specs/snooze-scheduling/spec.md`
- [ ] 6.3 Move change to `openspec/changes/archive/YYYY-MM-DD-snooze-throttle-mode/`
